                 ...
                 <div class="col-12">
                     <nav class="main-nav">
                         ...
                         <ul class="nav">
                             ...
                             <li><a href="#./views/become-a-seller.php" class="btn btn-primary" style="color:white;" data-toggle="modal" data-target="#MembershipModal">Become a seller</a></li>
                         </ul>
    ...
    <section class="section" id="trainers">
        <div class="container">
            ...
            <div class="main-button text-center">
                <a href="./views/products.php">View our products</a>
            </div>
        </div>
    </section>
    <!-- ***** Cars Ends ***** -->
