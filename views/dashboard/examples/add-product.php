...
$one = (new ProductController())->viewOneProduct($prod_id);
// var_dump($one);
// exit;
 ?>
...
<!--                                      <input id="name" type="text" placeholder="Name" class="form-control " name="name"   autocomplete="name" autofocus>-->
                              <select id="category_id" class="form-control pull-right" name="prod_category"  required>
                                  <option value="<?= $one[0]['category']?>" disabled selected> -- select category -- </option>
                                  <?php
                      ...
                      <div class="form-group">
                          <div class="input-group input-group-merge input-group-alternative mb-3">
                              ...
                              <input  type="text" placeholder="Product title" class="form-control " name="prod_title" id="prod_title" value="<?= $one[0]['product_title']?>"  autocomplete="title" autofocus required>
                              <input  type="hidden" placeholder="Product title" class="form-control " name="prod_title" id="prod_id" value="<?= $one[0]['product_id']?>"  >
                          </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="input-group input-group-merge input-group-alternative mb-3">
                              ...
                              <input  type="number" placeholder="Product price" value="<?= $one[0]['product_price']?>"class="form-control "  id="prod_price" name="prod_price" value="" autocomplete="price" required>
                      ...
                      <div class="form-group">
                          <div class="input-group input-group-merge input-group-alternative">
                              ...
                              <textarea   cols="2" rows="2" id="prod_desc" name="prod_desc"  value="<?= $one[0]['product_desc']?>" class="form-control"  placeholder="Product description" required></textarea>
                      ...
                      <div class="file-field">
                             <div class="btn btn-primary btn-sm float-left">
                               ...
                               <input type="file" name="prod_img" value="<?= $one[0]['product_img']?>" accept="image/png, image/jpeg,image/jpg,image/JPEG" required>
                             </div>
...
<!--                                  </div>-->
                      ...
                      <input type="submit" name="update_product" class="btn btn-primary pull-right" value="Update Product">
